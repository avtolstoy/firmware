...
DYNALIB_FN(28, hal_core, HAL_Core_Mode_Button_Mirror_Pin, void(uint16_t, InterruptMode, uint8_t, void*))
DYNALIB_FN(29, hal_core, HAL_Core_Mode_Button_Mirror_Pin_Disable, void(uint8_t, void*))
