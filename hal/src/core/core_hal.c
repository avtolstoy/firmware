...
void HAL_Core_Mode_Button_Mirror_Pin_Disable(uint8_t bootloader, void* reserved)
{
}

void HAL_Core_Mode_Button_Mirror_Pin(uint16_t pin, InterruptMode mode, uint8_t bootloader, void *reserved)
{
}
